...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun QuestionFactoryBottomSheet(
    ...
    ModalBottomSheet(
        onDismissRequest = {
            onEvent(QuestionFactoryStore.Event.CloseBottomSheet)
        },
        sheetState = state,
