...
fun EmptyListQuestionsNotificationBottomSheet(
    ...
    ModalBottomSheet(
        onDismissRequest = {
            onEvent(TestsListStore.Event.CloseNotificationBottomSheet)
        },
        sheetState = state,
        ...
        Column(
            ...
            val text = when (testsListType) {
                TestsListType.NORMAL -> stringResource(R.string.no_questions)
                TestsListType.FAVORITE -> stringResource(R.string.no_favorites)
                TestsListType.ERRORS -> stringResource(R.string.no_errors)
            }
            Text(
                text = stringResource(R.string.no_questions_notification_bottom_sheet, text),
                color = AppTheme.colors.text.primary,
